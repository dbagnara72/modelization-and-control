...
xlim([f1 f2]);
grid;
title('TR2 Output Current Spectrum','Interpreter','latex','FontSize',fontsize_plotting);
xlabel('$f/Hz$','Interpreter','latex','FontSize', fontsize_plotting);
ylabel('$i/A$','Interpreter','latex','FontSize', fontsize_plotting);
print('TR2_output_current_spectrum','-depsc');

TR2_output_current_rms = sqrt(mean(segnale.^2))
