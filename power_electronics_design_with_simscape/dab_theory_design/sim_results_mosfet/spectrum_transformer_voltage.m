...
N1=Nc-floor(20e-3/tc);
N2=Nc;
segnale = u1_hf_trafo_sim(N1:N2);
time = t(N1:N2);
...
xlim([f1 f2]);
grid;
title('Transformer Voltage Spectrum','Interpreter','latex','FontSize',fontsize_plotting);
xlabel('$f/Hz$','Interpreter','latex','FontSize', fontsize_plotting);
ylabel('$u/V$','Interpreter','latex','FontSize', fontsize_plotting);
print('transformer_voltage_spectrum','-depsc');

u_tr1_rms = sqrt(mean(segnale.^2))
