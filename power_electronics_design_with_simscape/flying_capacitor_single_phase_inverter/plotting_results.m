...
% print('sim_results_fig_1','-depsc');
% print('sim_results_fig_1','-djpeg');
% print('inverter_iv_stack_sim','-depsc');
...
figure;
subplot 211
plot(t_tc_sim,mosfet_51_power_losses_sim,'-','LineWidth',tratto2,'Color',colore1);
title('Mosfet Power Losses','Interpreter','latex','FontSize',fontsize_plotting);
legend('$p_{mos}$','Location','best',...
    'Interpreter','latex','FontSize',fontsize_plotting);
% xlabel('$t/s$','Interpreter','latex');
...
legend('$u_{Cfc}^{1}$','$u_{Cfc}^{2}$','$u_{Cfc}^{3}$',...
    '$u_{Cfc}^{4}$','$u_{Cfc}^{5}$','Location','NorthEast',...
    'Interpreter','latex','FontSize',fontsize_plotting);
xlabel('$t/s$','Interpreter','latex');
ylabel('$u/V$','Interpreter','latex','FontSize', fontsize_plotting);
% set(gca,'xlim',[t1c tc_end]);
set(gca,'xlim',[0 1.5]);
grid on
% print('flying_capacitors_voltage','-depsc');
...
hold off
title('Device $u_{ds}$ Voltages','Interpreter','latex','FontSize',fontsize_plotting);
legend('$u_{ds}^{51}$','$u_{ds}^{41}$','$u_{ds}^{31}$',...
    '$u_{ds}^{21}$','$u_{ds}^{11}$','Location','NorthEast',...
    'Interpreter','latex','FontSize',fontsize_plotting);
xlabel('$t/s$','Interpreter','latex');
ylabel('$u/V$','Interpreter','latex','FontSize', fontsize_plotting);
% set(gca,'xlim',[t1c tc_end]);
set(gca,'xlim',[0 1.5]);
grid on
% print('device_uds_voltage','-depsc');
