...
N2=Nc;
segnale = CFi_dc_current_sim(N1:N2);
time = t(N1:N2);
...
xlim([f1 f2]);
grid;
title('CFi-dc Current Spectrum','Interpreter','latex','FontSize',fontsize_plotting);
xlabel('$f/Hz$','Interpreter','latex','FontSize', fontsize_plotting);
ylabel('$i/A$','Interpreter','latex','FontSize', fontsize_plotting);
print('CFi_dc_current_spectrum','-depsc');

CFi_dc_current_rms = sqrt(mean(segnale.^2))
