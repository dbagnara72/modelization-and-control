...
xlim([f1 f2]);
grid;
title('TR2 Output Voltage Spectrum','Interpreter','latex','FontSize',fontsize_plotting);
xlabel('$f/Hz$','Interpreter','latex','FontSize', fontsize_plotting);
ylabel('$u/V$','Interpreter','latex','FontSize', fontsize_plotting);
print('TR2_output_voltage_spectrum','-depsc');

TR2_output_voltage_rms = sqrt(mean(segnale.^2))
