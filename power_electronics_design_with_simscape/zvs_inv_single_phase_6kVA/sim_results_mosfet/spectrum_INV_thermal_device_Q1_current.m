...
N2=Nc;
segnale = i_device_Q1_thermal_inv_sim(N1:N2);
time = t(N1:N2);
...
title('INV Device Q1 Current','Interpreter','latex','FontSize',fontsize_plotting);
...
xlim([f1 f2]);
grid;
title('INV Device Q1 Current Spectrum','Interpreter','latex','FontSize',fontsize_plotting);
xlabel('$f/Hz$','Interpreter','latex','FontSize', fontsize_plotting);
ylabel('$i/A$','Interpreter','latex','FontSize', fontsize_plotting);
print('INV_device_Q1_current_spectrum','-depsc');

INV_device_Q1_current_rms = sqrt(mean(segnale.^2))
