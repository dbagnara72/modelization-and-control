...
N2=Nc;
segnale = LFu1_dc_current_sim(N1:N2);
time = t(N1:N2);
...
xlim([f1 f2]);
grid;
title('LFu-dc Current Spectrum','Interpreter','latex','FontSize',fontsize_plotting);
xlabel('$f/Hz$','Interpreter','latex','FontSize', fontsize_plotting);
ylabel('$i/A$','Interpreter','latex','FontSize', fontsize_plotting);
print('LFu_dc_current_spectrum','-depsc');

LFu_dc_current_rms = sqrt(mean(segnale.^2))
