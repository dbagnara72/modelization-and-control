...
title('Transformer Current','Interpreter','latex','FontSize',fontsize_plotting);
...
xlim([f1 f2]);
grid;
title('Transformer Current Spectrum','Interpreter','latex','FontSize',fontsize_plotting);
xlabel('$f/Hz$','Interpreter','latex','FontSize', fontsize_plotting);
ylabel('$i/A$','Interpreter','latex','FontSize', fontsize_plotting);
print('transformer_current_spectrum','-depsc');

i_tr1_rms = sqrt(mean(segnale.^2))
