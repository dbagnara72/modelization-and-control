...
xlim([f1 f2]);
grid;
title('Cs Voltage Spectrum','Interpreter','latex','FontSize',fontsize_plotting);
xlabel('$f/Hz$','Interpreter','latex','FontSize', fontsize_plotting);
ylabel('$u/V$','Interpreter','latex','FontSize', fontsize_plotting);
print('Cs_voltage_spectrum','-depsc');

Cs_voltage_rms = sqrt(mean(segnale.^2))
