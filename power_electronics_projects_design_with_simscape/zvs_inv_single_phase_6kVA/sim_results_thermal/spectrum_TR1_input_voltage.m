...
xlim([f1 f2]);
grid;
title('TR1 Input Voltage Spectrum','Interpreter','latex','FontSize',fontsize_plotting);
xlabel('$f/Hz$','Interpreter','latex','FontSize', fontsize_plotting);
ylabel('$u/V$','Interpreter','latex','FontSize', fontsize_plotting);
print('TR1_input_voltage_spectrum','-depsc');

TR1_input_voltage_rms = sqrt(mean(segnale.^2))
