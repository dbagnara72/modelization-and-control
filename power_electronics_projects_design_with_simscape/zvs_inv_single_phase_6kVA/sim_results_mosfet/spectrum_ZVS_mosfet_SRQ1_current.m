...
N2=Nc;
segnale = i_device_Q1_mosfet_rect_sim(N1:N2);
time = t(N1:N2);
...
xlim([f1 f2]);
grid;
title('ZVS Device SRQ1 Current Spectrum','Interpreter','latex','FontSize',fontsize_plotting);
xlabel('$f/Hz$','Interpreter','latex','FontSize', fontsize_plotting);
ylabel('$i/A$','Interpreter','latex','FontSize', fontsize_plotting);
print('ZVS_device_SRQ1_current_spectrum','-depsc');

ZVS_device_SRQ1_current_rms = sqrt(mean(segnale.^2))
