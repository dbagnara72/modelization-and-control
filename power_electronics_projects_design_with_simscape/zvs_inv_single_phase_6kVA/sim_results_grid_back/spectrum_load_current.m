...
N1=Nc-floor(1500e-3/tc);
N2=Nc;
segnale = load_current_sim(N1:N2);
time = t(N1:N2);
...
title('Load Current','Interpreter','latex','FontSize',fontsize_plotting);
...
xlim([f1 f2]);
grid;
title('Load Current Spectrum','Interpreter','latex','FontSize',fontsize_plotting);
xlabel('$f/Hz$','Interpreter','latex','FontSize', fontsize_plotting);
ylabel('$i/A$','Interpreter','latex','FontSize', fontsize_plotting);
print('load_current_spectrum','-depsc');

i_load_rms = sqrt(mean(segnale.^2))
