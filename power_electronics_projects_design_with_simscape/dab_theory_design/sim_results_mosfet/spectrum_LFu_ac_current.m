...
N2=Nc;
segnale = LFu_ac_current_sim(N1:N2);
time = t(N1:N2);
...
title('LFu-ac Current','Interpreter','latex','FontSize',fontsize_plotting);
...
xlim([f1 f2]);
grid;
title('LFu-ac Current Spectrum','Interpreter','latex','FontSize',fontsize_plotting);
xlabel('$f/Hz$','Interpreter','latex','FontSize', fontsize_plotting);
ylabel('$i/A$','Interpreter','latex','FontSize', fontsize_plotting);
print('LFu_ac_current_spectrum','-depsc');

LFu_ac_current_rms = sqrt(mean(segnale.^2))
