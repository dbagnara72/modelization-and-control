...
%% init ref filter
xp_init = 0.5;
xf_state_init = [0 xp_init]';
[Af, Bf, Cf] = tf2ss(1,[1 2 1]);
ref_filter_ss = ss(Af,Bf,Cf,0)

%% init fb filter
fb_filter_ss_init = xp_init*1e-6;
[Afb, Bfb, Cfb] = tf2ss(1,[1e-6 1]);
fb_filter_ss = ss(Afb,Bfb,Cfb,0)
