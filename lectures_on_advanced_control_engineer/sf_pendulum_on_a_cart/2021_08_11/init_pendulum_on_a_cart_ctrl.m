...
f1 = 0.2; f2 = 0.25; f3 = 5; f4 = 4; f5 = 0.1;
poles_sf = [-f1*2*pi, -f2*2*pi, -f3*2*pi, -f4*2*pi, -f5*2*pi]*2;
Ke = acker(Ae,Be,poles_sf)

%% osservatore nel dominio del tempo continuo
poles_obs = [-f1*2*pi, -f2*2*pi, -f3*2*pi, -f4*2*pi]*6;
...
f1 = 0.2; f2 = 0.25; f3 = 5; f4 = 4; f5 = 20;
